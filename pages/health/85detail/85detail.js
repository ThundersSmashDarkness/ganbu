  ...
  */
  ...
  onLoad: function (e) {
    ...
    lineChart = new wxCharts({    //定义一个wxCharts图表实例
      ...
      categories: ['2021-9-13', '2021-9-14', '2021-9-15', '2021-9-16', '2021-9-17', '2021-9-18', '2021-9-19'],    //模拟的x轴横坐标参数
      ...
      series: [{  //具体坐标数据
        ...
        data: [140,145, 148, 156,150,160,155],  //数据点
